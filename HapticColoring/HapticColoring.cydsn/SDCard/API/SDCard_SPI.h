...
extern void     `$INSTANCE_NAME`_WriteBuff256(uint8 * sRamBuff);
extern void     `$INSTANCE_NAME`_ReadBuff256(uint8 * sRamBuff);
extern void     `$INSTANCE_NAME`_WriteBuff(uint8 * sRamBuff, uint8  bCnt);
extern void     `$INSTANCE_NAME`_ReadBuff(uint8 * sRamBuff, uint8  bCnt);
