...
#include <project.h>			/* Include hardware specific declareation file here */
...
#define	CS_H()			SPI_CS_Write(1)     /* Set MMC CS "high" */
#define CS_L()			SPI_CS_Write(0)     /* Set MMC CS "low" */
#define CK_H()			SPI_SCLK_Write(1)   /* Set MMC SCLK "high" */
